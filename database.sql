...
--
-- Current Database: `mini_project`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `mini_project` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `actor` (
  ...
  PRIMARY KEY (`id`),
  KEY `role_id` (`role_id`),
  CONSTRAINT `actor_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`)
...
INSERT INTO `actor` VALUES (1,'super_admin','secret',1,'true','true','2023-05-30 13:02:17','2023-05-30 13:02:17');
